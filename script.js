$(document).ready(function(){
    ...
    var typed = new Typed(".typing", {
        strings: ["Engineering Student", "Aspiring web Developer"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true
    });
...
document.getElementById("contact-form").addEventListener("submit", function(event) {
    ...
    emailjs.init("Pz7zPLh75LTHVCIQL"); // Replace with your EmailJS Public key
    ...
    emailjs.send("service_jeeva", "template_jeeva", formData)
